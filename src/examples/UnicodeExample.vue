...
<template>
  <div class="unicodeexample">
    <MyHeader></MyHeader>
    <div class="card">
      <div class="card-header h5">Adabas Unicode example</div>
      <div class="card-body">
        <p>
          This example queries employee example file data which contains Unicode alpha characters. 
        </p>
           <Url :url="URL" />
       <b-pagination
          v-model="currentPage"
...
export default class UnicodeExample extends Vue {
  ...
  created() {
    ...
    store.commit("SET_URL", {url: config.Url() + this.$data.URL,method:"get"});
    return axios
